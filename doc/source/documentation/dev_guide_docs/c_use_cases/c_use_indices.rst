...
.. _c_creating_and_using_indices_reference_link:
...
For more information on indexing feature, refer to the
:ref:`Compression Streams <c_compression_streams_reference_link>` chapter.


This section will walk you through the steps in creating and using the
indices. Intel® Query Processing Library (Intel® QPL) implements two 
