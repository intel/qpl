...
The Intel® Query Processing Library (Intel® QPL) provides a common interface 
...
changes in your application. The Intel® QPL provides high performance implementations 
