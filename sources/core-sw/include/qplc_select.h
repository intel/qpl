...
typedef qplc_status_t (*qplc_select_i_t_ptr)(uint8_t* src_dst_ptr, const uint8_t* src2_ptr, uint32_t length);

typedef qplc_status_t (*qplc_select_t_ptr)(const uint8_t* src_ptr, const uint8_t* src2_ptr, uint8_t* dst_ptr,
                                           uint32_t length);
/**
...
OWN_QPLC_API(qplc_status_t, qplc_select_8u,
             (const uint8_t* src_ptr, const uint8_t* src2_ptr, uint8_t* dst_ptr, uint32_t length))

OWN_QPLC_API(qplc_status_t, qplc_select_16u,
             (const uint8_t* src_ptr, const uint8_t* src2_ptr, uint8_t* dst_ptr, uint32_t length))

OWN_QPLC_API(qplc_status_t, qplc_select_32u,
             (const uint8_t* src_ptr, const uint8_t* src2_ptr, uint8_t* dst_ptr, uint32_t length))
/** @} */
