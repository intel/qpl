...
OWN_QPLC_INLINE(void, qplc_pack_be_8u_nu,
...
OWN_QPLC_FUN(void, qplc_pack_be_8u1u,
...
OWN_QPLC_FUN(void, qplc_pack_be_8u2u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
...
OWN_QPLC_FUN(void, qplc_pack_be_8u3u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
...
OWN_QPLC_FUN(void, qplc_pack_be_8u4u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
...
OWN_QPLC_FUN(void, qplc_pack_be_8u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr,
              uint32_t UNREFERENCED_PARAMETER(start_bit))) {
...
OWN_QPLC_FUN(void, qplc_pack_be_8u32u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr,
              uint32_t UNREFERENCED_PARAMETER(start_bit))) {
