...
OWN_QPLC_INLINE(void, qplc_unpack_be_Nu8u,
...
OWN_QPLC_FUN(void, qplc_unpack_be_1u8u,
...
OWN_QPLC_FUN(void, qplc_unpack_be_2u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_3u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_4u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_5u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_6u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_7u8u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_be_8u8u,
