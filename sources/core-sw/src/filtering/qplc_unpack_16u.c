...
OWN_QPLC_INLINE(void, qplc_unpack_Nu16u,
...
OWN_QPLC_FUN(void, qplc_unpack_9u16u,
...
OWN_QPLC_FUN(void, qplc_unpack_10u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_11u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_12u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_13u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_14u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_15u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint32_t start_bit, uint8_t* dst_ptr)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_unpack_16u16u,
