...
OWN_QPLC_FUN(void, qplc_scan_lt_8u,
...
OWN_QPLC_FUN(void, qplc_scan_lt_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_lt_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_eq_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_eq_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_eq_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ne_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ne_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ne_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_le_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_le_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_le_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_gt_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_gt_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_gt_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ge_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ge_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_ge_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value,
              uint32_t UNREFERENCED_PARAMETER(high_value))) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_range_8u,
...
OWN_QPLC_FUN(void, qplc_scan_range_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_range_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_not_range_8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_not_range_16u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_scan_not_range_32u8u,
             (const uint8_t* src_ptr, uint8_t* dst_ptr, uint32_t length, uint32_t low_value, uint32_t high_value)) {
#if PLATFORM >= K0
