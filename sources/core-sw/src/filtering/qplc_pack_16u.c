...
OWN_QPLC_INLINE(void, qplc_pack_16u_nu,
...
OWN_QPLC_FUN(void, qplc_pack_16u9u,
...
OWN_QPLC_FUN(void, qplc_pack_16u10u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u11u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u12u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u13u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u14u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u15u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr, uint32_t start_bit)) {
#if PLATFORM >= K0
...
OWN_QPLC_FUN(void, qplc_pack_16u16u,
...
OWN_QPLC_FUN(void, qplc_pack_16u32u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t* dst_ptr,
              uint32_t UNREFERENCED_PARAMETER(start_bit))) {
#if PLATFORM >= K0
