...
OWN_QPLC_FUN(qplc_status_t, qplc_pack_bits_nu,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t** pp_dst, uint32_t start_bit,
...
OWN_QPLC_FUN(qplc_status_t, qplc_pack_index_8u,
...
OWN_QPLC_FUN(qplc_status_t, qplc_pack_index_8u16u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t** pp_dst, uint32_t dst_length,
              uint32_t* index_ptr)) {
...
OWN_QPLC_FUN(qplc_status_t, qplc_pack_index_8u32u,
             (const uint8_t* src_ptr, uint32_t num_elements, uint8_t** pp_dst, uint32_t dst_length,
              uint32_t* index_ptr)) {
