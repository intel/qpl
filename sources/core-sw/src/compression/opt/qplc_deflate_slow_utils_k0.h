...
#ifndef QPL_SOURCES_CORE_SW_SRC_COMPRESSION_OPT_QPLC_DEFLATE_SLOW_UTILS_K0_H
#define QPL_SOURCES_CORE_SW_SRC_COMPRESSION_OPT_QPLC_DEFLATE_SLOW_UTILS_K0_H
...
#endif //QPL_SOURCES_CORE_SW_SRC_COMPRESSION_OPT_QPLC_DEFLATE_SLOW_UTILS_K0_H
