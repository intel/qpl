...
template <execution_path_t path, class stream_t = traits::common_type_for_huffman_only_stream<path>>
auto compress_huffman_only(uint8_t* begin, const uint32_t size, stream_t& stream) noexcept
