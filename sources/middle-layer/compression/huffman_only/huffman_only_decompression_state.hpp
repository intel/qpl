...
#ifndef QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_DECOMPRESSION_STATE_HPP
#define QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_DECOMPRESSION_STATE_HPP
...
public:
    ...
    inline auto decompress_table(decompression_huffman_table& decompression_table) noexcept
            -> huffman_only_decompression_state&;

    inline auto set_is_gen1_hw(bool is_gen1) noexcept -> huffman_only_decompression_state&;
...
template <class iterator_t>
inline auto huffman_only_decompression_state<execution_path_t::software>::output(iterator_t begin,
...
template <class iterator_t>
inline auto huffman_only_decompression_state<execution_path_t::software>::input(iterator_t begin,
                                                                                iterator_t end) noexcept
        -> huffman_only_decompression_state& {
...
inline auto huffman_only_decompression_state<execution_path_t::software>::crc_seed(uint32_t seed) noexcept
        -> huffman_only_decompression_state& {
...
inline auto huffman_only_decompression_state<execution_path_t::software>::endianness(endianness_t endianness) noexcept
        -> huffman_only_decompression_state& {
...
inline auto huffman_only_decompression_state<execution_path_t::software>::last_bits_offset(uint8_t value) noexcept
        -> huffman_only_decompression_state& {
...
[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::software>::get_input_size() const noexcept
        -> uint32_t {
    return state_->source_available;
}

[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::software>::get_endianness() noexcept
        -> endianness_t {
    return endianness_;
}

[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::software>::get_lookup_table() noexcept
        -> uint8_t* {
    return lookup_table_ptr_;
}

[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::software>::get_fields() noexcept
        -> internal_state_fields_t& {
    return *state_;
}

/* ------ HARDWARE STATE METHODS ------ */
template <class iterator_t>
inline auto huffman_only_decompression_state<execution_path_t::hardware>::output(iterator_t begin,
                                                                                 iterator_t end) noexcept
        -> huffman_only_decompression_state& {
...
template <class iterator_t>
inline auto huffman_only_decompression_state<execution_path_t::hardware>::input(iterator_t begin,
                                                                                iterator_t end) noexcept
        -> huffman_only_decompression_state& {
...
inline auto huffman_only_decompression_state<execution_path_t::hardware>::crc_seed(uint32_t seed) noexcept
        -> huffman_only_decompression_state& {
    crc_ = seed;
...
inline auto huffman_only_decompression_state<execution_path_t::hardware>::endianness(endianness_t endianness) noexcept
        -> huffman_only_decompression_state& {
    endianness_ = endianness;
...
inline auto huffman_only_decompression_state<execution_path_t::hardware>::set_is_gen1_hw(bool is_gen1) noexcept
        -> huffman_only_decompression_state& {
    is_gen1_hw_ = is_gen1;
...
inline auto huffman_only_decompression_state<execution_path_t::hardware>::build_descriptor() noexcept
        -> hw_descriptor* {
...
[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::hardware>::handler() const noexcept
        -> HW_PATH_VOLATILE hw_completion_record* {
    return completion_record_;
}

[[nodiscard]] inline auto huffman_only_decompression_state<execution_path_t::hardware>::get_input_size() const noexcept
        -> uint32_t {
    return input_size_;
}

} // namespace qpl::ml::compression
#endif //QPL_SOURCES_MIDDLE_LAYER_COMPRESSION_HUFFMAN_ONLY_HUFFMAN_ONLY_DECOMPRESSION_STATE_HPP
