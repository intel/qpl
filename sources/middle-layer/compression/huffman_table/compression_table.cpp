...
compression_huffman_table::compression_huffman_table(uint8_t *sw_table_ptr,
    ...
    sw_compression_table_ptr_   = reinterpret_cast<sw_compression_huffman_table *>(sw_table_ptr);
...
auto compression_huffman_table::get_sw_compression_table() noexcept -> sw_compression_huffman_table * {
