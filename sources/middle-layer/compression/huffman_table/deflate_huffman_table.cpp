...
compression_huffman_table::compression_huffman_table(uint8_t* sw_table_ptr, uint8_t* isal_table_ptr,
                                                     uint8_t* hw_table_ptr, uint8_t* deflate_header_ptr) noexcept
