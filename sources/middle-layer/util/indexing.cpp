...
qpl_status qpl_get_index_table_size(uint32_t mini_block_count,
    ...
    *size_ptr = block_count * 2u + mini_block_count + 1u;
...
qpl_status qpl_find_header_block_index(qpl_index_table *table_ptr,
    ...
    uint32_t blockNumber = mini_block_number / table_ptr->mini_blocks_per_block;

    *block_index_ptr = blockNumber * (table_ptr->mini_blocks_per_block + 2u);
...
qpl_status qpl_find_mini_block_index(qpl_index_table *table_ptr,
    ...
    qpl_status status = qpl_find_header_block_index(table_ptr, mini_block_number, &currentHeaderIndex);
    ...
    uint32_t blockNumber            = mini_block_number / table_ptr->mini_blocks_per_block;
    uint32_t miniBlockNumberInBlock = mini_block_number - blockNumber * table_ptr->mini_blocks_per_block;

    *block_index_ptr = currentHeaderIndex + 1u + miniBlockNumberInBlock;
