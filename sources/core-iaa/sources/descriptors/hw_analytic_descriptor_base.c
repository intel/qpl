...
HW_PATH_IAA_API(void, descriptor_analytic_set_filter_input,
    ...
    this_ptr->src1_ptr           = source_ptr;
    this_ptr->src1_size          = source_size;
    this_ptr->num_input_elements = elements_count;
...
HW_PATH_IAA_API(void, descriptor_analytic_set_filter_output,
    ...
    uint32_t output_modifiers = (output_format & (hw_iaa_output_modifier_big_endian | hw_iaa_output_modifier_inverse |
                                                  hw_iaa_output_modifier_force_array));

    this_ptr->dst_ptr      = output_ptr;
    this_ptr->max_dst_size = output_size;
