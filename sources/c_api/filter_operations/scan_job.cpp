...
uint32_t perform_scan(qpl_job* job_ptr, uint8_t* buffer_ptr, uint32_t buffer_size) {
    ...
    switch (job_ptr->data_ptr.path) {
        case qpl_path_hardware: {
            ...
            auto input_stream = analytics::input_stream_t::builder(src_begin, src_end)
                                        ...
                                        .decompress_buffer<execution_path_t::hardware>(decompress_buffer_begin,
                                                                                       decompress_buffer_end)
            ...
            if (bad_arg_status != status_list::ok) { return bad_arg_status; }

            limited_buffer_t temporary_buffer(buffer_ptr, buffer_ptr + buffer_size, input_stream.bit_width());

            switch (job_ptr->op) {
                case qpl_op_scan_eq: {
                    scan_result = analytics::call_scan<analytics::comparator_t::equals, execution_path_t::hardware>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer,
                            job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_ne: {
                    scan_result = analytics::call_scan<analytics::comparator_t::not_equals, execution_path_t::hardware>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer,
                            job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_lt: {
                    scan_result = analytics::call_scan<analytics::comparator_t::less_than, execution_path_t::hardware>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer,
                            job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_le: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::less_equals, execution_path_t::hardware>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer, job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_gt: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::greater_than, execution_path_t::hardware>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer, job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_ge: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::greater_equals, execution_path_t::hardware>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer, job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_not_range: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::out_of_range, execution_path_t::hardware>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer, job_ptr->numa_id);
                    break;
                }
                case qpl_op_scan_range: {
                    scan_result = analytics::call_scan<analytics::comparator_t::in_range, execution_path_t::hardware>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer,
                            job_ptr->numa_id);
                    break;
                }
        ...
        case qpl_path_software: {
            ...
            auto input_stream = analytics::input_stream_t::builder(src_begin, src_end)
                                        ...
                                        .compressed(job_ptr->flags & QPL_FLAG_DECOMPRESS_ENABLE,
                                                    static_cast<qpl_decomp_end_proc>(job_ptr->decomp_end_processing),
                                                    job_ptr->ignore_end_bits)
                                        .decompress_buffer<execution_path_t::auto_detect>(decompress_buffer_begin,
                                                                                          decompress_buffer_end)
                                        .stream_format(input_stream_format, job_ptr->src1_bit_width)
            ...
            switch (job_ptr->op) {
                case qpl_op_scan_eq: {
                    scan_result = analytics::call_scan<analytics::comparator_t::equals, execution_path_t::software>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer);
                    break;
                }
                case qpl_op_scan_ne: {
                    scan_result = analytics::call_scan<analytics::comparator_t::not_equals, execution_path_t::software>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer);
                    break;
                }
                case qpl_op_scan_lt: {
                    scan_result = analytics::call_scan<analytics::comparator_t::less_than, execution_path_t::software>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer);
                    break;
                }
                case qpl_op_scan_le: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::less_equals, execution_path_t::software>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer);
                    break;
                }
                case qpl_op_scan_gt: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::greater_than, execution_path_t::software>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer);
                    break;
                }
                case qpl_op_scan_ge: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::greater_equals, execution_path_t::software>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer);
                    break;
                }
                case qpl_op_scan_not_range: {
                    scan_result =
                            analytics::call_scan<analytics::comparator_t::out_of_range, execution_path_t::software>(
                                    input_stream, output_stream, job_ptr->param_low, job_ptr->param_high,
                                    temporary_buffer);
                    break;
                }
                case qpl_op_scan_range: {
                    scan_result = analytics::call_scan<analytics::comparator_t::in_range, execution_path_t::software>(
                            input_stream, output_stream, job_ptr->param_low, job_ptr->param_high, temporary_buffer);
                    break;
                }
                default: {
    ...
    if (QPL_STS_OK == scan_result.status_code_) { update_job(job_ptr, scan_result); }
