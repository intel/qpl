...
uint32_t perform_select(qpl_job* job_ptr, uint8_t* unpack_buffer_ptr, uint32_t unpack_buffer_size,
    ...
    switch (job_ptr->data_ptr.path) {
        case qpl_path_hardware: {
            ...
            // Configure buffers
            limited_buffer_t unpack_buffer(unpack_buffer_ptr, unpack_buffer_ptr + unpack_buffer_size,
            ...
            result = call_select<execution_path_t::hardware>(input_stream, mask_stream, output_stream, unpack_buffer,
                                                             set_buffer, output_buffer, job_ptr->numa_id);
            break;
        }
        case qpl_path_auto: {
            auto input_stream = analytics::input_stream_t::builder(src_begin, src_end)
            ...
            result = call_select<execution_path_t::auto_detect>(input_stream, mask_stream, output_stream, unpack_buffer,
                                                                set_buffer, output_buffer, job_ptr->numa_id);
            break;
        }
        case qpl_path_software: {
            ...
            result = call_select<execution_path_t::software>(input_stream, mask_stream, output_stream, unpack_buffer,
