...
static inline int deflate_dict_fuzz(const uint8_t* Data, size_t Size,
   ...
   
    {
        ...
        qpl_status status = qpl_gather_deflate_statistics(source.data(),
            source.size(),
            &histogram,
            compression_level,
            qpl_path_software);
        ...
        qpl_build_compression_table(&histogram,
            huffman_table,
