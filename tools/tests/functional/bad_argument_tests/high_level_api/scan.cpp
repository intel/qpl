...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, zero_destination_size) {
    ...
    auto scan_operation = qpl::scan_operation();
...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, incorrect_destination_size) {
    ...
    auto scan_operation = qpl::scan_operation::builder(qpl::scan_operation())
    ...
    auto scan_operation_parser = qpl::scan_operation::builder(qpl::scan_operation())
            .parser<qpl::parsers::little_endian_packed_array>(number_of_input_elements)
            .output_vector_width(output_vector_width)
            .build();

    auto status_with_parser = test::get_execute_status(scan_operation_parser,
                                                       source.begin(),
                                                       source.end(),
                                                       destination.begin(),
                                                       destination.end());
...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, incorrect_source_size) {
...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, buffer_overlap) {
...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, incorrect_prle_input_bit_width) {
...
QPL_HIGH_LEVEL_API_BAD_ARGUMENT_TEST(scan, num_elements_with_index_output) {
    ...
    auto scan_operation_8u = qpl::scan_operation::builder(qpl::scan_operation())
        .number_of_input_elements(number_of_input_elements)
    ...
    auto status = test::get_execute_status(scan_operation_8u,
        source.begin(),
        source.end(),
        destination.begin(),
        destination.end());
    ...
    auto scan_operation_16u = qpl::scan_operation::builder(qpl::scan_operation())
        .number_of_input_elements(number_of_input_elements)
        .input_vector_width(8u)
    ...
    status = test::get_execute_status(scan_operation_16u,
        source.begin(),
        source.end(),
        destination.begin(),
        destination.end());
    ...
    auto scan_operation_32u = qpl::scan_operation::builder(qpl::scan_operation())
        .number_of_input_elements(number_of_input_elements)
        .input_vector_width(8u)
    ...
    status = test::get_execute_status(scan_operation_32u,
        source.begin(),
        source.end(),
        destination.begin(),
        destination.end());
