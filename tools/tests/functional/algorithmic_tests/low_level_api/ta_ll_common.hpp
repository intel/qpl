...
#ifndef QPL_TESTS_FUNCTIONAL_ALGORITHMIC_TESTS_LOW_LEVEL_API_TA_COMMON_H_
#define QPL_TESTS_FUNCTIONAL_ALGORITHMIC_TESTS_LOW_LEVEL_API_TA_COMMON_H_
...
#endif //QPL_TESTS_FUNCTIONAL_ALGORITHMIC_TESTS_LOW_LEVEL_API_TA_COMMON_H_
