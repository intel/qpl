...
class token_parser_c
{
    protected:
        ...
        token_type_t parse_one_string(token_c *token,
                                      const char *str, uint32_t strlen,
                                      token_type_t type);

        token_type_t parse_two_strings(token_c *token,
                                       const char *str1, uint32_t strlen1,
                                       token_type_t type1,
                                       const char *str2, uint32_t strlen2,
                                       token_type_t type2);

        token_type_t parse_three_strings(token_c *token,
                                         const char *str1, uint32_t strlen1,
                                         token_type_t type1,
                                         const char *str2, uint32_t strlen2,
                                         token_type_t type2,
