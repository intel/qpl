 ...
 * @return
 */
REF_INLINE qpl_status own_compare(const uint32_t *const source_ptr,
 ...
 * @return
 */
REF_INLINE qpl_status own_compare_output_to_format(const uint32_t *const source_ptr,
                                                   uint32_t number_of_elements,
...
REF_INLINE qpl_status own_compare_le_be(qpl_job *const qpl_job_ptr) {
    ...
    // main action
    status = own_compare(extracted_ptr,
                         number_of_elements,
                         results_ptr,
                         corrected_low_value,
                         corrected_high_value,
                         qpl_job_ptr->op);
