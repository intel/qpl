 ...
 * @todo
 */
#define REF_CHECK_PTR_END(ptr, limit, upd, sts) { if ((ptr) > ((limit)-(upd))){ return (sts); }};

/**
 * @todo
 */
#define REF_CHECK_FUNC_STS(func) { qpl_status _s = func; if (QPL_STS_OK != _s){ return _s; }}
...
#define REF_BAD_ARG_RET(expr, err_code) { if(expr) { REF_ERROR_RET(err_code); }}    /**< @todo */
#else
 ...
 * @todo
 */
#define REF_BAD_PTR2_RET(ptr1, ptr2) { REF_BAD_PTR_RET(ptr1); REF_BAD_PTR_RET(ptr2) }

/**
 * @todo
 */
#define REF_BAD_PTR3_RET(ptr1, ptr2, ptr3) { REF_BAD_PTR2_RET(ptr1, ptr2); REF_BAD_PTR_RET(ptr3) }
 ...
 * @todo
 */
#define REF_FREE_PTR2(ptr1, ptr2) { REF_FREE_PTR(ptr1); REF_FREE_PTR(ptr2); }

/**
 * @todo
 */
#define REF_FREE_PTR3(ptr1, ptr2, ptr3) { REF_FREE_PTR2(ptr1, ptr2); REF_FREE_PTR(ptr3); }
