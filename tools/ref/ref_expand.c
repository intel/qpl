 ...
 * @return
 */
REF_INLINE qpl_status own_expand(const uint32_t *const source_ptr,
 ...
 * @return
 */
REF_INLINE qpl_status own_expand_output_to_format(const uint32_t *const source_ptr,
                                                  uint32_t number_of_elements,
...
REF_INLINE qpl_status own_expand_le_be(qpl_job *const qpl_job_ptr) {
    ...
    // Store result
    status = own_expand_output_to_format(results_ptr,
                                         number_of_elements,
                                         source_bit_width,
                                         available_bytes,
                                         qpl_job_ptr);
